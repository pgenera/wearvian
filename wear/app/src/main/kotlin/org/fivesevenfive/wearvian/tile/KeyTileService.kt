...
class KeyTileService : TileService() {
    ...
    private companion object {
        ...
        // "5": reverted the 0.9.6 single-toggle + window redesign back to this open/close layout —
        // bump forward past the shipped "4" so the renderer refreshes off the window-icon set.
